		...
		<div class="w3-row">
			...
			<div class="w3-row w3-row-padding w3-content"
				...
				<div class=" w3-col s6 m3 l3">
					<a href="${pageContext.servletContext.contextPath }/submain#공학"
						class="short-cut">
				...
				<div class=" w3-col s6 m3 l3">
					<a href="${pageContext.servletContext.contextPath }/submain#농수해양학"
						class="short-cut">
						<div class="w3-center w3-round-large w3-padding">
							<div>
				...
				<div class=" w3-col s6 m3 l3">
					<a href="${pageContext.servletContext.contextPath }/submain#복합학"
						class="short-cut">
						<div class="w3-center w3-round-large w3-padding">
							<div>
								<i class="far fa-code-merge fa-3x "></i>
				...
				<div class=" w3-col s6 m3 l3">
					<a href="${pageContext.servletContext.contextPath }/submain#사회과학"
						class="short-cut">
						<div class="w3-center w3-round-large w3-padding">
							<div>
				...
				<div class=" w3-col s6 m3 l3">
					<a href="${pageContext.servletContext.contextPath }/submain#인문학"
						class="short-cut">
						<div class="w3-center w3-round-large w3-padding">
							<div>
				...
				<div class=" w3-col s6 m3 l3">
					<a href="${pageContext.servletContext.contextPath }/submain#의약학"
						class="short-cut">
						<div class="w3-center w3-round-large w3-padding">
							<div>
				...
				<div class=" w3-col s6 m3 l3">
					<a href="${pageContext.servletContext.contextPath }/submain#예술체육학"
						class="short-cut">
						<div class="w3-center w3-round-large w3-padding">
							<div>
				...
				<div class=" w3-col s6 m3 l3">
					<a href="${pageContext.servletContext.contextPath }/submain#자연과학"
						class="short-cut">
						<div class="w3-center w3-round-large w3-padding">
							<div>
